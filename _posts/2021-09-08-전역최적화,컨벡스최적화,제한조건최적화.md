...
함수 전 구간에 대해 최적화 해서, (반드시) 전역 최저점을 찾아내는 최적화 방법
...
주로 Convex, Concave 함수를 컨벡스 최적화 한다. 
...
'2차 도함수가 0 이상인 구간에서 정의된 최적화'

다변수함수의 경우 

## $x^{T}Hx \ge 0$

헤시안 행렬이 양의 준정부호인 영역에서만 정의된 최적화

즉, 함수 $f(x)$의 볼록구간에서만 정의된 최적화라는 것이다. 
